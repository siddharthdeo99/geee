...
<div class="cursor-pointer flex items-start p-4 border-b border-gray-200 classic:border-black dark:border-white/10{{ $active ? ' md:bg-gray-100 dark:md:bg-gray-800' : '' }}"

>
    <img src="{{ $message->conversation->ad->primaryImage ?? asset('/images/placeholder.jpg') }}"  alt="User Photo" class="w-12 h-12 rounded-xl object-cover">
